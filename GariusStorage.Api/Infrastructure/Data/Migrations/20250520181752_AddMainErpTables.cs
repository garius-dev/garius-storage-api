...
{
    /// <inheritdoc />
    public partial class AddMainErpTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MunicipalRegistration = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    CPF = table.Column<string>(type: "character varying(18)", maxLength: 18, nullable: true),
                    Phone = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    Enabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxUnitOfMeasure = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    TaxQuantityPerUnit = table.Column<decimal>(type: "numeric(18,4)", nullable: false),
                    Origin = table.Column<int>(type: "integer", nullable: false),
                    ICMS_CST = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    ICMS_Rate = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    PIS_CST = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    PIS_Rate = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    COFINS_CST = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    COFINS_Rate = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    IPI_Rate = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    ANVISA_Code = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    ...
                    TaxSituation = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    Enabled = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastUpdate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NFeKey = table.Column<string>(type: "character varying(44)", maxLength: 44, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CashFlows_Purchases_PurchaseId",
